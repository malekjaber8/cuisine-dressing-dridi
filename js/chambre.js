const CHAMBRE_PROJECTS = [
  { title: 'Chambre', images: ['images/chambre a coucher/1.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/2.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/3.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/4.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/5.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/6.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/7.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/8.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/9.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/10.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/11.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/12.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/13.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/14.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/15.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/16.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/17.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/18.jpeg'] },
  { title: 'Chambre', images: ['images/chambre a coucher/19.jpeg'] }
];
...
function renderGrid() {
  const grid = document.getElementById('chambreGrid');
  grid.innerHTML = CHAMBRE_PROJECTS.map((project, index) => `
  ...
  grid.querySelectorAll('.project-card').forEach(card => {
    card.addEventListener('click', () => {
      openLightbox(CHAMBRE_PROJECTS[card.dataset.project], 0);
    });
  });
