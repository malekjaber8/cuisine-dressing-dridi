const MEUBLE_TV_PROJECTS = [
  { title: 'Meuble TV', images: ['images/meuble TL/1.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/2.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/3.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/4.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/5.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/6.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/7.jpeg'] },
  { title: 'Meuble TV', images: ['images/meuble TL/8.jpeg'] }
];
...
function renderGrid() {
  const grid = document.getElementById('meubleTvGrid');
  grid.innerHTML = MEUBLE_TV_PROJECTS.map((project, index) => `
  ...
  grid.querySelectorAll('.project-card').forEach(card => {
    card.addEventListener('click', () => {
      openLightbox(MEUBLE_TV_PROJECTS[card.dataset.project], 0);
    });
  });
